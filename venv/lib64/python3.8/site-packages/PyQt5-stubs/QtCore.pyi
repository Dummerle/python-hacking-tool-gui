...
class QJsonDocument(sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, array: typing.Iterable[typing.Union[
        'QJsonValue', 'QJsonValue.Type', typing.Dict[str, 'QJsonValue'], bool, int, float, str]]) -> None: ...
    ...
    def setArray(self, array: typing.Iterable[typing.Union[
        'QJsonValue', 'QJsonValue.Type', typing.Dict[str, 'QJsonValue'], bool, int, float, str]]) -> None: ...
...
typing.Callable[[FuncT], FuncT]: ...  # fix issue #6
